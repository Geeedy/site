...
PAGES = {
 ...
 "prediktivnaya-analitika": ("/uslugi/vnedrenie-ii/prediktivnaya-analitika/", {"ru":"Предиктивная аналитика","en":"Predictive Analytics"}, "vnedrenie-ii"),
 "generativnyy-ii":      ("/uslugi/vnedrenie-ii/generativnyy-ii/", {"ru":"Генеративный ИИ","en":"Generative AI"}, "vnedrenie-ii"),
 "kompyuternoe-zrenie":  ("/uslugi/vnedrenie-ii/kompyuternoe-zrenie/", {"ru":"Компьютерное зрение","en":"Computer Vision"}, "vnedrenie-ii"),
 "rechevaya-analitika":  ("/uslugi/vnedrenie-ii/rechevaya-analitika/", {"ru":"Речевая аналитика","en":"Speech Analytics"}, "vnedrenie-ii"),
 "bot-na-gpt":           ("/uslugi/chat-boty/bot-na-gpt/", {"ru":"Чат-бот на GPT","en":"GPT Chatbot"}, "chat-boty"),
 "bitrix24-integraciya": ("/uslugi/vnedrenie-crm/bitrix24/integraciya/", {"ru":"Интеграция Битрикс24","en":"Bitrix24 Integration"}, "vnedrenie-crm"),
 "bitrix24-nastroika":  ("/uslugi/vnedrenie-crm/bitrix24/nastroika/", {"ru":"Настройка Битрикс24","en":"Bitrix24 Setup"}, "vnedrenie-crm"),
 "bitrix24-korobka":    ("/uslugi/vnedrenie-crm/bitrix24/korobochnaya-versiya/", {"ru":"Коробочная версия Битрикс24","en":"Bitrix24 On-Premise"}, "vnedrenie-crm"),
 "avtomatizaciya-prodazh": ("/uslugi/vnedrenie-crm/avtomatizaciya-prodazh/", {"ru":"Автоматизация продаж","en":"Sales Automation"}, "vnedrenie-crm"),
 "audit-crm":           ("/uslugi/vnedrenie-crm/audit-crm/", {"ru":"Аудит CRM","en":"CRM Audit"}, "vnedrenie-crm"),
 "avtomatizaciya-sklada": ("/uslugi/vnedrenie-ii/avtomatizaciya-sklada/", {"ru":"Автоматизация склада","en":"Warehouse Automation"}, "vnedrenie-ii"),
 "avtomatizaciya-kliniki": ("/uslugi/vnedrenie-ii/avtomatizaciya-kliniki/", {"ru":"Автоматизация клиники","en":"Clinic Automation"}, "vnedrenie-ii"),
 "crm-dlya-stomatologii": ("/uslugi/vnedrenie-crm/dlya-stomatologii/", {"ru":"CRM для стоматологии","en":"CRM for Dental Clinics"}, "vnedrenie-crm"),
 "ii-dlya-marketpleysov": ("/uslugi/ii-agenty/dlya-marketpleysov/", {"ru":"ИИ для маркетплейсов","en":"AI for Marketplaces"}, "ii-agenty"),
 "perenos-sayta":        ("/uslugi/razrabotka-saitov/perenos-sayta/", {"ru":"Перенос сайта","en":"Website Migration"}, "razrabotka-saitov"),
 "crm-dlya-malogo-biznesa": ("/uslugi/vnedrenie-crm/crm-dlya-malogo-biznesa/", {"ru":"CRM для малого бизнеса","en":"CRM for Small Business"}, "vnedrenie-crm"),
 "dlya-zapisi":           ("/uslugi/chat-boty/dlya-zapisi/", {"ru":"Чат-бот для записи","en":"Booking Chatbot"}, "chat-boty"),
 "crm-dlya-nedvizhimosti": ("/uslugi/vnedrenie-crm/dlya-nedvizhimosti/", {"ru":"CRM для недвижимости","en":"CRM for Real Estate"}, "vnedrenie-crm"),
 "crm-dlya-avtoservisa":  ("/uslugi/vnedrenie-crm/dlya-avtoservisa/", {"ru":"CRM для автосервиса","en":"CRM for Auto Service"}, "vnedrenie-crm"),
 "crm-dlya-salona-krasoty": ("/uslugi/vnedrenie-crm/dlya-salona-krasoty/", {"ru":"CRM для салона красоты","en":"CRM for Beauty Salon"}, "vnedrenie-crm"),
 "avtomatizaciya-proizvodstva": ("/uslugi/vnedrenie-ii/avtomatizaciya-proizvodstva/", {"ru":"Автоматизация производства","en":"Manufacturing Automation"}, "vnedrenie-ii"),
 "sait-na-bitrikse":     ("/uslugi/razrabotka-saitov/sait-na-bitrikse/", {"ru":"Сайт на Битрикс","en":"Bitrix Website"}, "razrabotka-saitov"),
 "integraciya-sayta":    ("/uslugi/razrabotka-saitov/integraciya-sayta/", {"ru":"Интеграция сайта","en":"Website Integration"}, "razrabotka-saitov"),
 "crm-dlya-kliniki":     ("/uslugi/vnedrenie-crm/dlya-kliniki/", {"ru":"CRM для клиники","en":"CRM for Clinics"}, "vnedrenie-crm"),
 "crm-dlya-stroitelnoy-kompanii": ("/uslugi/vnedrenie-crm/dlya-stroitelnoy-kompanii/", {"ru":"CRM для строительной компании","en":"CRM for Construction"}, "vnedrenie-crm"),
 "crm-dlya-magazina":    ("/uslugi/vnedrenie-crm/dlya-magazina/", {"ru":"CRM для магазина","en":"CRM for Retail"}, "vnedrenie-crm"),
 "crm-dlya-shkoly":      ("/uslugi/vnedrenie-crm/dlya-shkoly/", {"ru":"CRM для школы","en":"CRM for Schools"}, "vnedrenie-crm"),
 "crm-dlya-yuristov":    ("/uslugi/vnedrenie-crm/dlya-yuristov/", {"ru":"CRM для юристов","en":"CRM for Law Firms"}, "vnedrenie-crm"),
 "ii-assistent-dlya-biznesa": ("/uslugi/ii-agenty/ii-assistent-dlya-biznesa/", {"ru":"ИИ-ассистент для бизнеса","en":"AI Assistant for Business"}, "ii-agenty"),
 "multiagentnye-sistemy": ("/uslugi/ii-agenty/multiagentnye-sistemy/", {"ru":"Мультиагентные системы","en":"Multi-Agent Systems"}, "ii-agenty"),
 "crm-dlya-fitnes-kluba": ("/uslugi/vnedrenie-crm/dlya-fitnes-kluba/", {"ru":"CRM для фитнес-клуба","en":"CRM for Fitness Clubs"}, "vnedrenie-crm"),
 "bot-podderzhki":       ("/uslugi/chat-boty/bot-podderzhki/", {"ru":"Бот поддержки","en":"Support Chatbot"}, "chat-boty"),
 "sait-na-wordpress":    ("/uslugi/razrabotka-saitov/sait-na-wordpress/", {"ru":"Сайт на WordPress","en":"WordPress Website"}, "razrabotka-saitov"),
 "sait-katalog":         ("/uslugi/razrabotka-saitov/sait-katalog/", {"ru":"Сайт-каталог","en":"Catalog Website"}, "razrabotka-saitov"),
 "redizayn-sayta":       ("/uslugi/razrabotka-saitov/redizayn-sayta/", {"ru":"Редизайн сайта","en":"Website Redesign"}, "razrabotka-saitov"),
 "podderzhka-sayta":     ("/uslugi/razrabotka-saitov/podderzhka-sayta/", {"ru":"Техподдержка сайта","en":"Website Maintenance"}, "razrabotka-saitov"),
 "promo-sait":           ("/uslugi/razrabotka-saitov/promo-sait/", {"ru":"Промо-сайт","en":"Promo Website"}, "razrabotka-saitov"),
 "razrabotka-marketplace": ("/uslugi/razrabotka-saitov/razrabotka-marketplace/", {"ru":"Разработка маркетплейса","en":"Marketplace Development"}, "razrabotka-saitov"),
 "magazin-na-bitrikse":  ("/uslugi/razrabotka-saitov/internet-magazin/na-bitrikse/", {"ru":"Магазин на Битрикс","en":"Bitrix Online Store"}, "razrabotka-saitov"),
 "magazin-na-tilde":     ("/uslugi/razrabotka-saitov/internet-magazin/na-tilde/", {"ru":"Магазин на Тильде","en":"Tilda Online Store"}, "razrabotka-saitov"),
 "ii-baza-znaniy":       ("/uslugi/vnedrenie-ii/ii-baza-znaniy/", {"ru":"База знаний ИИ (RAG)","en":"AI Knowledge Base (RAG)"}, "vnedrenie-ii"),
 "nlp-analiz-obrashcheniy": ("/uslugi/vnedrenie-ii/nlp-analiz-obrashcheniy/", {"ru":"NLP-анализ обращений","en":"NLP Text Analysis"}, "vnedrenie-ii"),
 "agent-dlya-dokumentooborota": ("/uslugi/ii-agenty/dlya-dokumentooborota/", {"ru":"ИИ-агент для документов","en":"AI Document Agent"}, "ii-agenty"),
 "agent-dlya-finansov":  ("/uslugi/ii-agenty/dlya-finansov/", {"ru":"ИИ-агент для финансов","en":"AI Finance Agent"}, "ii-agenty"),
 "bot-dlya-avito":       ("/uslugi/chat-boty/bot-dlya-avito/", {"ru":"Чат-бот для Авито","en":"Avito Chatbot"}, "chat-boty"),
 "max-bot":              ("/uslugi/chat-boty/max-bot/", {"ru":"Чат-бот для MAX","en":"MAX Chatbot"}, "chat-boty"),
 "vk-bot":               ("/uslugi/chat-boty/vk-bot/", {"ru":"Чат-бот для ВКонтакте","en":"VK Chatbot"}, "chat-boty"),
 "kviz-bot":             ("/uslugi/chat-boty/kviz-bot/", {"ru":"Квиз-бот","en":"Quiz Bot"}, "chat-boty"),

...
<head>
  ...
  <link rel="stylesheet" href="{u('/css/styles.css')}?v=13">
  <link rel="stylesheet" href="{u('/css/pages.css')}?v=13">
...
<script src="{u('/js/main.js')}?v=13"></script>
</body>
</html>'''
...
<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;600;700&family=Sumana&display=swap" rel="stylesheet">
<link rel="stylesheet" href="{u('/css/styles.css')}?v=13"><link rel="stylesheet" href="{u('/css/pages.css')}?v=13"></head>
...
</main>{footer_html(lang)}<script src="{u('/js/main.js')}?v=13"></script></body></html>'''
...
</main>{footer_html("en")}<script src="{u('/js/main.js')}?v=13"></script></body></html>'''
...
def patch_home(lang="ru"):
    ...
    h = re.sub(r'href="[^"]*css/(styles|pages)\.css[^"]*"', lambda m: f'href="{u("/css/"+m.group(1)+".css")}?v=13"', h)
    h = re.sub(r'src="[^"]*/js/main\.js[^"]*"', f'src="{u("/js/main.js")}?v=13"', h)
